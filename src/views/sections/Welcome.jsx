    ...
    return (
        <section id="intro-accueil" className="container py-5 mx-auto">
            ...
            <div id="texte-accueil" className="text-center leading-loose">
                ...
                <p>
                    Chez les Canibales 79 il y en a pour tous les objectifs :
                    <br />
                    <strong>Dépassement de soi</strong>,{" "}
                    <strong>routine sportive </strong>ou{" "}
                    <strong>promenade active</strong>
                    ,<br />
                    Chacun et chacune à son rythme y trouvera forcément sa
                    place.
                    <br />
                </p>

                <p>
                    Au gré de nos sorties à <strong>Niort et alentours</strong>{" "}
                    : Chauray, Celles sur Belle, le Lambon...
                    <br />
                ...
                <p>
                    Alors n'hésitez plus et venez vous initier aux CANICROSS,
                    CANIVTT et CANIMARCHE avec nous,
                    <br />
                    promis nous ne vous mordrons pas{" "}
                    <small className="italic">
                        (ou seulement un petit peu, nous avons une réputation à
                        tenir)
                    </small>
                    ...
                </p>
                ...
                <p className="mt-5 italic">
                    ...
                    <br />
                    découvrir les disciplines, les bonnes pratiques et plus
                    encore !
                </p>
