<section id="rubriques" class="container-fluid py-5 px-1 px-sm-5 mx-auto bg-black">
    <div class="row g-5">
            ...
            <a href="/infos-pratiques">
                <div class="card">
                    ...
                    <div class="card-body px-lg-4 text-black">
                        ...
                        <p class="card-text">Horaires et types d'entraînements, compétitions, infos sur les licences. Si vous souhaitez intégrer les CANIBALES79, c'est aussi par ici !
                        </p>
                    </div>
                </div>
            </a>
                ...
                <div class="card">
                    ...
                    <div class="card-body px-lg-4 text-black">
                        ...
                        <p class="card-text">Les réponses aux questions les plus fréquemment posées.<br>
                            Notre <strong>formulaire de
                                contact</strong> est également à votre disposition.
                        </p>
                    </div>
                </div>
            </a>
