        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Création d'une nouvelle QUESTION / RÉPONSE</h1>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="{{ route('faq.store') }}" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="question" name="question" type="text" value="{{ old('question') }}" placeholder="Ex. : Je n'aime pas courir, est-ce que je peux quand même aimer le canicross ?" required>
                        </div>
                        {{-- input REPONSE --}}
                        <div class="mb-3">
                            <label for="reponse" class="form-label fw-bold">RÉPONSE</label>
                            <input type="text" class="form-control" id="reponse" name="reponse"
                                placeholder="Ex. : Tout à fait ! Le canicross est une autre dimension de la course à pied, et nombreux sont les pratiquants qui se surprennent à aimer courir une fois qu'ils se mettent au canicross. Courir avec son chien, ça change tout ;)" value="{{ old('reponse') }}" required>
                        </div>
                        {{-- bouton VALIDER --}}
                        <div class="text-center">
