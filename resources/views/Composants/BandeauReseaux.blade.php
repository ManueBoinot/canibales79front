...
<section id="reseaux"
    ...
    <a href="https://www.facebook.com/Canibales79" class="text-white" style="font-size: 40px" target="blank"><i
            class="fa-brands fa-square-facebook"></i>
    </a>
    <a href="https://www.instagram.com/canibales_79/" class="text-white" style="font-size: 40px" target="blank"><i
