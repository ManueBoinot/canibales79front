<section id="actu" class="container-lg py-5 px-1 px-sm-5 mx-auto bg-white">
    <div class="row g-4 text-center">
        <h2 class="text-center fw-bold">ACTUALITÉ DU CLUB</h2>

        <!-- Article presse 1 -->
        <div class="col-lg-4">
            <a href="https://www.lanouvellerepublique.fr/deux-sevres/commune/souvigne-79/saint-maixent-le-canicross-fait-son-retour-dans-la-foret-de-l-hermitain"
                target="_blank">
                ...
                <div class="card text-bg-dark mx-auto">
                    ...
                    <div class="card-img-overlay py-4 py-lg-3 py-xxl-5">
                        ...
                        <p class="card-text py-4 fs-5">Saint-Maixent : le canicross fait son retour dans la forêt de
                            l’Hermitain</p>
                        <p class="card-text"><small>16/05/2022</small></p>
                    </div>
                </div>
            </a>
        </div>
